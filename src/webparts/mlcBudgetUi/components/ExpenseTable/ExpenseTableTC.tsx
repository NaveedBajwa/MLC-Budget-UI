...
export interface IExpenseTableTCProps {
...
export interface IExpenseTableTCState {
  trColor:string;
  items:any[];
  itemsTotal:any[];
...
export class ExpenseTableTC extends React.Component<IExpenseTableTCProps, IExpenseTableTCState> {
  
  constructor(props: IExpenseTableTCProps) {
    super(props);
...
                </tr>
  ...
  public async SetItemsWS(): Promise<any[]> {
    ...
    let WSS = Constants.apiURL + '/GetTCExpenseTableByBudgetCategory_CostCentre_FY?budgetCategory=' + this.props.budgetCategoryId + '&costCenter='+ 
...
public async SetItemsTotalWS(): Promise<any[]> {
  ...
  let WSS = Constants.apiURL + '/GetTCExpenseTableByBudgetCategory_CostCentre_FY_Total?budgetCategory=' + this.props.budgetCategoryId + '&costCenter='+ 
      this.props.costCenterId +'&FY=' + this.props.budgetYearText;
  try{
  return await this.props.budgetAppClient
  .get(WSS , AadHttpClient.configurations.v1)
