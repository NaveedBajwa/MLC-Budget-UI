...
export interface IExpenseTableFAProps {
...
export interface IExpenseTableFAState {
  trColor:string;
  items:any[];
  itemsTotal:any[];
...
export class ExpenseTableFA extends React.Component<IExpenseTableFAProps, IExpenseTableFAState> {
  
  constructor(props: IExpenseTableFAProps) {
    super(props);
...
                </tr>
  ...
  public async SetItemsWS(): Promise<any[]> {
    ...
    let WSS = Constants.apiURL + '/GetFAExpenseTableByBudgetCategory_CostCentre_FY?budgetCategory=' + this.props.budgetCategoryId + '&costCenter='+ 
...
public async SetItemsTotalWS(): Promise<any[]> {
  ...
  let WSS = Constants.apiURL + '/GetFAExpenseTableByBudgetCategory_CostCentre_FY_Total?budgetCategory=' + this.props.budgetCategoryId + '&costCenter='+ 
      this.props.costCenterId +'&FY=' + this.props.budgetYearText;
  try{
  return await this.props.budgetAppClient
  .get(WSS , AadHttpClient.configurations.v1)
