...
public async DeleteItemWS()
{
  ...
  public UpdateItem()
  {
    ...
    if(this.state.AccountNumberId == '0')
    {
      this.setState({ hideDialog: false, dialogMsg:"Missing Item Category", dialogBoxMsg: "Please select an Item Category"});
      return 1;
    }
